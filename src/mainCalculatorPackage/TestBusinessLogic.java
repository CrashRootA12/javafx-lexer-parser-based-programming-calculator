 ...
 * @version 4.10    2017-01-21  Integer calculator with subtraction, multiplication and division
 * @version 4.20    2018-02-16  Double Calculator with square root added
 * @version 4.30    2018-02-25	FSM Implemented Error Messages
 * @version 4.40    2018-03-23 	Error Term Implementation
...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		boolean flag = test.setOperand1("1234567890123456","0", null);					// Perform the test
		...
		flag = test.setOperand2("1234560123456789","0", null);							// Perform the test
		...
		test.setOperand1("12345678","0", null);
		test.setOperand2("87654321","0", null);
		...
		test.setOperand1("12345678","0", null);
		test.setOperand2("87654321","0", answer);
		...
		test.setOperand1("12345678","0", answer);
		test.setOperand2("87654321","0", answer);
		...
		test.setOperand1("12345678", null, null);
		test.setOperand2("87654321",null, null);
